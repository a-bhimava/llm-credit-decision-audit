  ...
  return (
    <section className="studio" aria-label="Audit Studio">
      ...
      <div className="studioConversation">
        ...
        <div className="conversationBody" style={submission === "launched" ? { display: "none" } : undefined}>
        ...
        {submission === "launched" && (
          <div className="launchReaction" style={{ position: "absolute", top: 60, left: 0, right: 0, bottom: 0, overflow: "hidden", zIndex: 10 }}>
