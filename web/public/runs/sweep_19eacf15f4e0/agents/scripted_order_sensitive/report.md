...
- **Reordering the same transaction multiset changes nothing** — 22.2% of 45 matched, bilaterally decisive trials changed decision signature under invariance.statement_order in this scripted known-answer run.
  95% CI [0.000, 0.444] (BCa), n=45 over 9 source applicants (`est_1474a66b`, 9 tests)
...
| `invariance.statement_order` | 9 | 7 | 2 | 0 | 0 | 22.2% | [0.000, 0.444] |
