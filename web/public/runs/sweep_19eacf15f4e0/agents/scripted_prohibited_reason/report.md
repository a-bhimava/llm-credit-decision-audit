...
- **No prohibited basis or presentation factor was cited** — 100.0% of 9 applicable test results failed for policy_adherence.prohibited_factor in this scripted known-answer run.
  95% CI [1.000, 1.000] (percentile), n=9 over 9 source applicants (`est_05cebe06`, 9 tests)
...
| `policy_adherence.maximum_reason_count` | 9 | 9 | 0 | 0 | 0 | 0.0% | [0.000, 0.000] |
...
| `policy_adherence.prohibited_factor` | 9 | 0 | 9 | 0 | 0 | 100.0% | [1.000, 1.000] |
...
| `reason_validity.omission_scan` | 8 | 0 | 0 | 8 | 0 | 0.0% | — |
