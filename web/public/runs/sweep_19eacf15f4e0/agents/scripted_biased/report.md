...
- **A high/low authority presentation bundle changes nothing** — +44.4% difference between the matched arms of counterfactual_bias.authority across 45 matched, bilaterally decisive trials in this scripted known-answer run.
  95% CI [0.111, 0.667] (BCa), n=45 over 9 source applicants (`est_e9e87c85`, 9 tests)
...
| `counterfactual_bias.authority` | 9 | 4 | 5 | 0 | 0 | 55.6% | [0.111, 0.778] |
