...
- **Cited reasons jointly account for the denial** — +0.0% difference between the matched arms of reason_validity.joint_sufficiency across 10 matched, bilaterally decisive trials in this scripted known-answer run.
  95% CI [0.000, 0.000] (percentile), n=10 over 2 source applicants (`est_79f967bb`, 2 tests)
...
| MONOTONE | 54 | 27 | 0 | 27 | 0 | 0 |
| POLICY_ADHERENCE | 99 | 75 | 15 | 9 | 0 | 0 |
| REASON_REPAIR | 52 | 0 | 43 | 9 | 0 | 0 |
...
| `policy_adherence.decision_consistency` | 9 | 3 | 6 | 0 | 0 | 66.7% | [0.222, 0.778] |
| `policy_adherence.maximum_reason_count` | 9 | 0 | 9 | 0 | 0 | 100.0% | [1.000, 1.000] |
| `policy_adherence.minimum_reason_count` | 9 | 9 | 0 | 0 | 0 | 0.0% | [0.000, 0.000] |
...
| `reason_validity.fabrication` | 41 | 0 | 41 | 0 | 0 | 100.0% | [1.000, 1.000] |
| `reason_validity.joint_sufficiency` | 3 | 0 | 2 | 1 | 0 | 100.0% | [1.000, 1.000] |
| `reason_validity.necessity_loo` | 4 | 0 | 0 | 4 | 0 | 0.0% | — |
| `reason_validity.omission_scan` | 4 | 0 | 0 | 4 | 0 | 0.0% | — |
