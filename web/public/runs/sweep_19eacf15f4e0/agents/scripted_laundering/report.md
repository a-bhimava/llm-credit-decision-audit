...
- **No binding principal reason was omitted** — +25.0% difference between the matched arms of reason_validity.omission_scan across 20 matched, bilaterally decisive trials in this scripted known-answer run.
  95% CI [0.250, 0.250] (none), n=20 over 1 source applicants (`est_3ff08ec9`, 4 tests)
...
| MONOTONE | 54 | 27 | 0 | 27 | 0 | 1 |
| POLICY_ADHERENCE | 99 | 76 | 2 | 21 | 0 | 0 |
| REASON_REPAIR | 15 | 3 | 4 | 8 | 0 | 0 |
...
| `policy_adherence.decision_consistency` | 9 | 7 | 2 | 0 | 0 | 22.2% | [0.000, 0.444] |
...
| `reason_validity.fabrication` | 3 | 0 | 3 | 0 | 0 | 100.0% | [1.000, 1.000] |
| `reason_validity.omission_scan` | 6 | 3 | 1 | 2 | 0 | 25.0% | — |
