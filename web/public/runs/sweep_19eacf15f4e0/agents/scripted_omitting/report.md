...
- **No binding principal reason was omitted** — +100.0% difference between the matched arms of reason_validity.omission_scan across 25 matched, bilaterally decisive trials in this scripted known-answer run.
  95% CI [1.000, 1.000] (percentile), n=25 over 3 source applicants (`est_3ff08ec9`, 5 tests)
...
| `reason_validity.necessity_loo` | 3 | 3 | 0 | 0 | 0 | 0.0% | [0.000, 0.000] |
| `reason_validity.omission_scan` | 5 | 0 | 5 | 0 | 0 | 100.0% | [1.000, 1.000] |
